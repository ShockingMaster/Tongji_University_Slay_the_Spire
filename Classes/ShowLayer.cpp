...
bool ShowLayer::init( int op) {
    ...
    if (_background) {
        _background->setScale(1.1f);
        _background->setColor(cocos2d::Color3B(240, 240, 240));
        _background->setPosition(cocos2d::Vec2(1000, 820));
    ...
    closeButton->setPosition(cocos2d::Vec2(1940, 290));
    ...
    returnLabel->setPosition(cocos2d::Vec2(1790, 360));  // 设置Label的位置，使其在按钮上方
    ...
    if (op == 1) {
        ...
        background4->setPosition(Vec2(1000,800));
        ...
        Label1->setPosition(cocos2d::Vec2(1000, 660));  // 设置Label的位置，使其在按钮上方
    ...
    if (op == 2) {
        ...
        Label1->setTextColor(cocos2d::Color4B::WHITE);
        Label1->setPosition(cocos2d::Vec2(1000, 460));  // 设置Label的位置，使其在按钮上方
        this->addChild(Label1, 103);  // Label的层级高于按钮
        audioPlayer("gold.ogg", false);
